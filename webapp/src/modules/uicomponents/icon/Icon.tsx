...
function User(props: IconBaseProps): ReactElement {
    return (
        // https://fontawesome.com/icons/classic/solid/user
        // Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-user"], props.className)}
        >
            <path
...
function Lock(props: IconBaseProps): ReactElement {
    return (
        // https://fontawesome.com/icons/classic/solid/lock
        // Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-lock"], props.className)}
        >
            <path
...
function Eye(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-eye"], props.className)}
        >
            <path
...
function EyeSlash(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-eye-lash"], props.className)}
        >
            <path
...
function Check(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-check"], props.className)}
        >
            <path
...
function Bell(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-bell"], props.className)}
        >
            <path
...
function PenToSquare(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-pen-to-square"], props.className)}
        >
            <path
...
function UserPlus(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-user-plus"], props.className)}
        >
            <path
...
function List(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-list"], props.className)}
        >
            <path
...
function ChevronRight(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-chevron-right"], props.className)}
        >
            <path
...
function ChevronLeft(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-chevron-left"], props.className)}
        >
            <path
...
function ChevronUp(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-chevron-up"], props.className)}
        >
            <path
...
function ChevronDown(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-chevron-down"], props.className)}
        >
            <path
...
function Plus(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-plus"], props.className)}
        >
            <path
...
function Cross(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-cross"], props.className)}
        >
            <path
...
function Spinner(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-spinner"], styles["icon--spinning"], props.className)}
        >
            <path
...
function TrashCan(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-trash-can"], props.className)}
        >
            <path
...
function Gear(props: IconBaseProps): ReactElement {
    return (
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-gear"], props.className)}
        >
            <path
...
function ArrowUpRightFromSquare(props: IconBaseProps): ReactElement {
    return (
        // https://fontawesome.com/icons/classic/solid/up-right-from-square
        // Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
            className={classNames(styles.icon, styles["icon-arrow-up-right-from-square"], props.className)}
        >
            <path
