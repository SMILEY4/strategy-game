...
import {type GLUniformValueType} from "@rendergraph/webgl/gl-program.ts";
import {GlFramebuffer} from "@rendergraph/webgl/gl-framebuffer.ts";
import {mat4, vec3} from "gl-matrix";
import {GlError} from "@rendergraph/webgl/gl-error.ts";
import type {ValueEntry, WebGlCommand} from "@rendergraph/compile/webgl/webgl-compiler.ts";
import {WebGlExecutionContext} from "@rendergraph/execute/webgl/webgl-execution-context.ts";
