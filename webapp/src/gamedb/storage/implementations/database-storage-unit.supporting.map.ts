 ...
 * - a key can map to multiple entities
 */
export class MapSupportingStorage<ENTITY, KEY> implements SupportingDatabaseStorageUnit<ENTITY> {
    ...
    public onInsert(entity: ENTITY): void {
        const key = this.keyProvider(entity);
