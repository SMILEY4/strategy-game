...
/**
 * Maps arbitrary keys to entities in an n-m key-entity-relation:
 * - multiple keys can map to one entity
 * - a single key can map to multiple entities.
 */
export class MapMultikeySupportingStorage<ENTITY, KEY> implements SupportingDatabaseStorageUnit<ENTITY> {
