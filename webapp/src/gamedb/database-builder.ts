...
import type {IdProvider} from "@gamedb/storage/id-provider.ts";
import type {Database} from "@gamedb/database/database.ts";
import {DatabaseImpl} from "@gamedb/database/database-implementation.ts";
import {SingletonDatabaseImpl} from "@gamedb/singleton/singleton-database-implementation.ts";
