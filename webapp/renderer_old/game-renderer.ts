import {WebGlRenderGraph} from "src/modules/rendergraph/render-graph.ts";
import {gameGraph} from "src/pages/game/renderer/graph/game-graph.ts";
import {RenderGraphBuilder} from "src/modules/rendergraph/render-graph-builder.ts";
import {gameRendererDataProvider, type GameRendererDataProvider} from "src/pages/game/renderer/data/game-renderer-data-provider.ts";
import {type RenderWasmApi, gameGraphWasmApiJsImplementation} from "src/pages/game/renderer/wasm/render-wasm-api.ts";
import {DI} from "src/app/app.ts";
