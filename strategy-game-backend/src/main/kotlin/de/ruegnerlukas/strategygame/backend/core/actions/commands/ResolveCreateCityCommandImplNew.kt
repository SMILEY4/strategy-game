...
// TODO: classname
class ResolveCreateCityCommandImplNew(
    ...
    override suspend fun perform(
        ...
        return Monitoring.coTime(metricId) {
            ...
            either {
                ...
                CreateCityValidationsNew.validateCommand(gameConfig, cmdData.name, game, country, targetTile, cmdData.withNewProvince)
                    .ifInvalid<Unit> { reasons ->
                        return@either reasons.map { CommandResolutionError(command, it) }
                    }
                val cityId = createCity(game, country.countryId, targetTile, cmdData.name, cmdData.withNewProvince)
    ...
    private suspend fun getOrCreateProvince(game: GameExtended): Province {
...
private object CreateCityValidationsNew { // TODO: classname
