/**
 * Maps arbitrary keys to entities in a 1-n key-entity-relation, i.e. a key can map to multiple entities.
 */
export class MapSupportingStorage<ENTITY, KEY> implements SupportingDatabaseStorage<ENTITY> {
