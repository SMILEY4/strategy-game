...
export function ProductionWindow(props: ProductionWindowProps): ReactElement {
	const data: UseProductionWindow.Data = UseProductionWindow.useData(props.settlement);
	return (
		<DecoratedWindow
...
function ProductionListEntry(props: { data: UseProductionWindow.Data, entry: SettlementProductionOption }) {
	return (
		<DecoratedPanel
			dontGrow
			dontShrink
