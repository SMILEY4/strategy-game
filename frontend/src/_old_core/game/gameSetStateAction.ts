import {MsgMarkerTileContent, MsgScoutTileContent} from "../../_old_external/api/models/messagingTileContent";
import {PayloadGameState} from "../../_old_external/api/models/payloadGameState";
...
} from "../../_old_external/api/models/productionQueueEntryDTO";
