...
export interface DrawRenderNodeConfig<TContext> {
    id: string,
    input: (NodeInput.VertexDescriptor | NodeInput.Shader | NodeInput.Texture<TContext> | NodeInput.TextureAtlas | NodeInput.RenderTarget | NodeInput.Property<TContext> | NodeInput.ClearColor | NodeInput.BlendMode)[]
