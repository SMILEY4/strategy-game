...
import {TilesBaseVertexNode} from "../../game/rendernodes/tilesBaseVertexNode";
import {OverlayBaseVertexNode} from "../../game/rendernodes/overlayBaseVertexNode";
...
export namespace RenderGraphPreloader {
	...
	export function tempLoad() {
		return preload([
			...
			new TilesVertexNode(null as any, null as any),
			new TilesBaseVertexNode(),
			new OverlayVertexNode(null as any, null as any, null as any),
