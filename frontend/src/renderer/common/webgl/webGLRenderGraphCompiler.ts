...
export class WebGLRenderGraphCompiler implements RenderGraphCompiler<WebGLRenderCommand.Base> {
	...
	private getClearColor(node: DrawRenderNode<any>): [number, number, number, number] {
	...
	private getBlendFunction(node: DrawRenderNode<any>): ((gl: WebGL2RenderingContext) => void) | null {
