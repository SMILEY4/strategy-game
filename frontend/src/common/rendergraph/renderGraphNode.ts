...
//  */
// export abstract class BaseRenderGraphNode<TNode> implements RenderGraphNode {
//
...
// 	 */
// 	protected registerInput(input: RenderGraphNode): void {
...
// 	 */
// 	public getInputs(): RenderGraphNode[] {
