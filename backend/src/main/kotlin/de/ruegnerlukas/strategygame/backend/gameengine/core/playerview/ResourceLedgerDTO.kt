...
data class LedgerEntryDTO(
    ...
    val amount: Float,
    val missing: Float,
    val details: List<LedgerDetailDTO>
)
...
sealed class LedgerDetailDTO(val type: String) {

    companion object {

        fun of(serviceModel: LedgerResourceDetail): LedgerDetailDTO {
