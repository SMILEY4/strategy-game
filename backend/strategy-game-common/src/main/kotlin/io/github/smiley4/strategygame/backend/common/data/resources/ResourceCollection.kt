...
interface ResourceCollection {
    ...
    companion object {
         ...
         */
        fun basic(resources: Map<ResourceType, Number>): io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection {
            return io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection().also { collection ->
         ...
         * @return a new [BasicResourceCollection] with the given data
         */
        fun basic(resources: Collection<ResourceStack>): io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection {
            return io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection().also { collection ->
         ...
         * @return a new [BasicResourceCollection] with the given data
         */
        fun basic(vararg resources: ResourceStack): io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection {
            return io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection().also { collection ->
                resources.forEach { stack ->
                    collection.set(stack.type, stack.amount)
                }
         ...
         * @return a new [BasicResourceCollection] with the given data
         */
        fun basic(resources: ResourceCollection): io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection {
            return io.github.smiley4.strategygame.backend.common.data.resources.BasicResourceCollection().also { collection ->
                resources.forEach { type, amount ->
