package io.github.smiley4.strategygame.backend.common.websocket.routingconfig

import io.github.smiley4.strategygame.backend.common.websocket.session.WebSocketConnection
...
typealias OnConnectHandler = suspend (call: ApplicationCall, data: WebsocketConnectionData?) -> Unit
...
class WebsocketExtendedRouteConfig {
     ...
     * @param handler the callback - takes the request as [io.ktor.server.application.ApplicationCall] and the additional data extracted from the auth ticket
     */
