...
import io.github.smiley4.strategygame.backend.sessions.application.persistence.entities.ResourceLedgerEntryEntity.Companion.asServiceModel
...
internal data class ResourceLedgerEntity(
    ...
    companion object {
        ...
        fun ResourceLedgerEntity.asServiceModel(): ResourceLedger {
            ...
            return ResourceLedger.of(entries)
        }
