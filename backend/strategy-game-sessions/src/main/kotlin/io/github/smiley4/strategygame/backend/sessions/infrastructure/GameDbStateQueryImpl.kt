...
class GameDbStateQueryImpl(private val database: ArangoDatabase) :
    io.github.smiley4.strategygame.backend.sessions.connect.GameDbStateQuery,
    io.github.smiley4.strategygame.backend.sessions.join.GameDbStateQuery,
