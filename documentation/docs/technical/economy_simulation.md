...
- Entry for *Consumption*
    - resources were consumed/removed by a given entity from a given node (node does not need to be the direct parent/owner).

- Entry for *Production*
    - resources were produces/added from a given entity in a given node (node does not need to be the direct parent/owner).

- Entry for *Missing*
    - resources are missing for an entity, i.e. the difference between required input resources and actually consumed resources.
